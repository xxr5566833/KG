# -*- coding: UTF-8 -*-
import sys
sys.path.append("/home/xiaorui/myrepo/deep-keyphrase")
import os
import argparse
...
class CopyRnnTrainer(BaseTrainer):
    ...
    def parse_args(self, args=None):
        ...
        parser.add_argument("-beam_size", type=int, default=16, help='')
        ...
        parser.add_argument('-early_stop_tolerance', type=int, default=20, help='')
